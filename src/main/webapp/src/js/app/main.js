...
define("main", ["systemDefine-repos", "pure-dialog"], function (require, exports) {
    var
        ...
        footerHtml =
            ...
            '      <dt></dt>' + '      <dd>' + '        <a href="#">接受捐赠</a>' + '        <a href="bottom.html?title=mcjs">名词解释</a>' + '        <a href="bottom.html?title=wjxz">文件下载</a>' + '      </dd>' + '    </dl>' + '    <dl>' + '      <dt></dt>' + '      <dd>' +
            '        <a href="#">周公吐哺</a>' + '        <a href="bottom.html?title=hxjz">核心价值</a>' + '        <a href="bottom.html?title=tsjy">投诉建议</a>' +
