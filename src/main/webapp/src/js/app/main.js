...
define("main", ["systemDefine-repos", "pure-dialog"], function (require, exports) {
    var
        ...
        headerHtml =
            '  <div id="site_nav" role="navigation">' + '    <div class="ui-sn-container">' + '      <p class="ui-welcome">' + '        <em>Hello Dreamer! 您好:<span id="loginTitle"></span></em>' + '        <div class="scroll_div">' + '          <ul class="scroll_ul" id="scrollarea">' + '          </ul>' + '         </div>' + '      </p>' + '      <ul class="ui-quick-menu" id="quick_menu" style="display:none;">' + '        <li class="ui-sn_login">' + '          <a target="_self" href="login.html" title="登录">登录</a>' + '        </li>' + '        <li class="ui-sn_reg">' + '          <a href="main.html#quickRegister" title="还等什么亲，赶快去注册吧！">注册</a>' + '        </li></ul>' + '      <ul class="ui-quick-menu" id="loginout_menu" style="display:none;">' + '        <li class="ui-sn_reg" >' +
            '<span class="new_message glyphicon glyphicon-envelope"><span class="new_message_count"></span></span>          <a href="modifyUserInfo.html">设置</a>' + '</li>' + '        <li class="ui-sn_reg" >' + '          <a id="a_loginOut">退出</a>' + '        </li>' + '      </ul>' + '    </div>' + '  </div>' + '  <div style="position: absolute;width: 100%;"></div>' + '  <div class="ui-header">' + '    <h1 id="logo">' + '      <span class="mlogo">' + '        <div id="J_FpLogo">' + '          <a class="" href="index.html" title="我的中国梦">' + '            <img src="../image/logo.png" height="124" width="290" alt="我的中国梦">' + '          </a>' + '        </div>' + '      </span>' + '    </h1>' + '    <div class="ui-query">' + '      <div id="search">' + '        <div class="ui-search-combox">' + '          <input id="mq" type="text" name="search" value="" placeholder="请输入关键字">' + '        </div>' + '        <button type="button" title="查找对应询价名称" id="btn_search">搜索</button>' + '      </div>' + '    </div>' + '    <div class="ui-nav clearfloat">' + '        <ul id="nav">' +
            '<li data-mod="main" data-link="main.html"><a title="首页">首页</a></li>' + '<li data-mod="index" data-link="index.html"><a title="询价大厅">询价大厅</a></li>' + '<li data-mod="usercenter" data-link="userRoom.html">' + '<a title="用户大厅" >用户大厅</a>' + '          </li>' + '          <li data-mod="selfcenter" data-link="myZone.html">' + '            <a title="我的主页">我的主页</a>' + '          </li>' + '          <li data-mod="createinquiry" data-link="inquiryNew.html">' + '            <a title="询价发布" >发布询价</a>' + '          </li>' +
            '          <li data-mod="help" data-link="help.html">' + '            <a title="新手上路">新手上路</a>' + '          </li>' +
            '        </ul>' + '      </div>' + '  </div>',
        ...
        footerHtml =
            ...
            '      </dd>' + '    </dl>' + '    <dl>' + '      <dt></dt>' + '      <dd>' +
            '        <a href="bottom.html?title=twhd">提问回答(Q&A)</a>' + '        <a href="bottom.html?title=gszc">公司章程(节选)</a>' +
            '        <a href="bottom.html?title=cggz">采购规则(节选)</a>' + '      </dd>' + '    </dl>' + '    <dl>' +
            '      <dt></dt>' + '      <dd>' + '        <a href="bottom.html?title=zhxx">账户信息 </a>' + '        <a href="bottom.html?title=mcjs">名词解释</a>' + '        <a href="bottom.html?title=wjxz">文件下载</a>' + '</dd>' + '    </dl>' + '    <dl>' + '      <dt></dt>' + '      <dd>' +
            '        <a href="bottom.html?title=zgtp">周公吐哺</a>' + '        <a href="bottom.html?title=hxjz">核心价值</a>' + '        <a href="bottom.html?title=tsjy">投诉建议</a>' +
            '        <a href="bottom.html?title=wtjb">问题举报</a>' + '      </dd>' + '    </dl>' + '  </div>' + '  <div class="ui-share">' + '    <a href="http://t.qq.com/mychinadreams" target="_blank">' +
            '      <img src="../image/weiboicon32.png" height="32" width="32" alt="腾讯微博" title="腾讯官微">' + '    </a>' + '    <a href="http://www.weibo.com/5511866263/profile?topnav=1&wvr=6" target="_blank" title="新浪官微">' + '      <img src="../image/weibo.png" height="32" width="36" alt="新浪微博">' + '    </a>' + '    <a id="weixin">' + '      <img src="../image/weixin.png" height="32" width="38" alt="微信" title="微信扫一扫">' + '      <div id="weixinLogo" style="display: none;">' + '        <div class="ui-weicode"></div>' + '        <b></b>' + '      </div>' + '    </a>' + '  </div>' + '  <div class="ui-beian clearfloat">' + '    <span>© COPYRIGHT 2015-2018 <a href="http://www.miitbeian.gov.cn/" target="_blank">沪ICP备15008817</a>  mychinadreams.com</span>' + '  </div>',
    ...
    function fn_initEvent() {
        ...
        if (!fn_isLogin()) {
            ...
            $(".new_message_count").text(loadUserInfo().mailCount).click(function(){
                location.href = "myZone.html";
            });
        }
