...
define("main", ["systemDefine-repos", "pure-dialog"], function (require, exports) {
    var
        ...
        headerHtml =
            ...
            '          <li data-mod="help">' + '            <a title="新手上路">新手上路</a>' + '          </li>' +
            '          <li data-mod="zmzc">' + '            <a title="中梦众筹">中梦众筹</a>' + '          </li>' +
            '        </ul>' + '      </div>' + '  </div>',

        footerHtml =
            ' <div class="ui-title">' + '    <span>中梦国网</span>' + '  </div>' +
            '  <div class="ui-zhinan">' + '    <dl>' + '      <dt></dt>' + '      <dd>' +
            '        <a href="bottom.html?title=xzks">写在开始</a>' + '        <a href="bottom.html?title=csbj">产生背景</a>' + '        <a href="#">案例分析</a>' +
            '      </dd>' + '    </dl>' + '    <dl>' + '      <dt></dt>' + '      <dd>' +
            ...
            '      <dt></dt>' + '      <dd>' + '        <a href="#">接受捐赠</a>' + '        <a href="#">与我联系</a>' + '        <a href="#">文件下载</a>' + '      </dd>' + '    </dl>' + '    <dl>' + '      <dt></dt>' + '      <dd>' +
            '        <a href="#">周公吐哺</a>' + '        <a href="#">核心价值</a>' + '        <a href="bottom.html?title=tsjy">投诉建议</a>' +
            '        <a href="bottom.html?title=wtjb">问题举报</a>' + '      </dd>' + '    </dl>' + '  </div>' + '  <div class="ui-share">' + '    <a href="http://t.qq.com/mychinadreams" target="_blank">' +
            '      <img src="../image/weiboicon32.png" height="32" width="32" alt="腾讯微博" title="分享至腾讯微博">' + '    </a>' + '    <a href="http://www.weibo.com/5511866263/profile?topnav=1&wvr=6" target="_blank" title="分享至新浪微博">' + '      <img src="../image/weibo.png" height="32" width="36" alt="新浪微博">' + '    </a>' + '    <a id="weixin">' + '      <img src="../image/weixin.png" height="32" width="38" alt="微信" title="微信扫一扫">' + '      <div id="weixinLogo" style="display: none;">' + '        <div class="ui-weicode"></div>' + '        <b></b>' + '      </div>' + '    </a>' + '  </div>' + '  <div class="ui-beian clearfloat">' + '    <span>© COPYRIGHT 2015-2018 <a href="http://www.miitbeian.gov.cn/" target="_blank">沪ICP备15008817</a>  mychinadreams.com</span>' + '  </div>',
