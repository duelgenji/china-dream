...
define("main", ["systemDefine-repos", "pure-dialog"], function (require, exports) {
    var
        ...
        headerHtml =
            '  <div id="site_nav" role="navigation">' + '    <div class="ui-sn-container">' + '      <p class="ui-welcome">' + '        <em>Hello Dreamer! 您好:<span id="loginTitle"></span></em>' + '        <div class="scroll_div">' + '          <ul class="scroll_ul" id="scrollarea">' + '          </ul>' + '         </div>' + '      </p>' + '      <ul class="ui-quick-menu" id="quick_menu" style="display:none;">' + '        <li class="ui-sn_login">' + '          <a target="_self" href="login.html" title="登录">登录</a>' + '        </li>' + '        <li class="ui-sn_reg">' + '          <a href="main.html" title="还等什么亲，赶快去注册吧！">注册</a>' + '        </li></ul>' + '      <ul class="ui-quick-menu" id="loginout_menu" style="display:none;">' + '        <li class="ui-sn_reg" >' +
