...
public interface UserRepository extends MyRepository<User,Long>{
    ...
    @Query(value = "select u.email,u.nick_name from user u where u.status = 1 and u.removed = 0 " +
            "and ( u.removed_industry not like ?1 or u.removed_industry is null )",nativeQuery = true)
